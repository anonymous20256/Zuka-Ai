...
function loadUserGroupData() {
    try {
        ...
        console.error('Error loading user group data: - index.js:24', error);
        return {
            antibadword: {},
            antilink: {},
            welcome: {},
...
function saveUserGroupData(data) {
    try {
        ...
        console.error('Error saving user group data: - index.js:48', error);
        return false;
    }
}
...
async function setAntilink(groupId, type, action) {
    try {
        ...
        console.error('Error setting antilink: - index.js:68', error);
        return false;
    }
}
...
async function getAntilink(groupId, type) {
    try {
        ...
        console.error('Error getting antilink: - index.js:80', error);
        return null;
    }
}
...
async function removeAntilink(groupId, type) {
    try {
        ...
        console.error('Error removing antilink: - index.js:94', error);
        return false;
    }
}
...
async function incrementWarningCount(groupId, userId) {
    try {
        ...
        console.error('Error incrementing warning count: - index.js:111', error);
        return 0;
    }
}
...
async function resetWarningCount(groupId, userId) {
    try {
        ...
        console.error('Error resetting warning count: - index.js:125', error);
        return false;
    }
}
...
async function isSudo(userId) {
    try {
        ...
        console.error('Error checking sudo: - index.js:136', error);
        return false;
    }
}
...
async function addWelcome(jid, enabled, message) {
    try {
        ...
        data.welcome[jid] = {
            ...
            channelId: '120363419125195694@newsletter'
        };
        
        saveUserGroupData(data);
        return true;
    } catch (error) {
        console.error('Error in addWelcome: - index.js:156', error);
        return false;
    }
}
...
async function delWelcome(jid) {
    try {
        ...
        console.error('Error in delWelcome: - index.js:170', error);
        return false;
    }
}
...
async function isWelcomeOn(jid) {
    try {
        ...
        console.error('Error in isWelcomeOn: - index.js:180', error);
        return false;
    }
}
...
async function addGoodbye(jid, enabled, message) {
    try {
        ...
        console.error('Error in addGoodbye: - index.js:199', error);
        return false;
    }
}
...
async function delGoodBye(jid) {
    try {
        ...
        console.error('Error in delGoodBye: - index.js:213', error);
        return false;
    }
}
...
async function isGoodByeOn(jid) {
    try {
        ...
        console.error('Error in isGoodByeOn: - index.js:223', error);
        return false;
    }
}
...
async function setAntiBadword(groupId, type, action) {
    try {
        ...
        console.error('Error setting antibadword: - index.js:243', error);
        return false;
    }
}
...
async function getAntiBadword(groupId, type) {
    try {
        ...
        if (!data.antibadword || !data.antibadword[groupId]) {
            console.log('No antibadword config found - index.js:255');
            return null;
        }
       ...
       // console.log('Found config:', config);
        ...
        console.error('Error getting antibadword: - index.js:264', error);
        return null;
    }
}
...
async function removeAntiBadword(groupId, type) {
    try {
        ...
        console.error('Error removing antibadword: - index.js:278', error);
        return false;
    }
}
...
async function setChatbot(groupId, enabled) {
    try {
        ...
        console.error('Error setting chatbot: - index.js:295', error);
        return false;
    }
}
...
async function getChatbot(groupId) {
    try {
        ...
        console.error('Error getting chatbot: - index.js:305', error);
        return null;
    }
}
...
async function removeChatbot(groupId) {
    try {
        ...
        console.error('Error removing chatbot: - index.js:319', error);
        return false;
    }
}
