...
async function scriptCommand(sock, chatId, message) {
    try {
        ...
        const repoUrl = "https://github.com/anonymous2025/Zuka-Ai";
        const zipUrl = `${repoUrl}/archive/refs/heads/main.zip`;

        // Fetch repo details
        const { data: repo } = await axios.get("https://api.github.com/repos/anonymous/Zuka-Ai");
