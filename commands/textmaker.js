...
async function textmakerCommand(sock, chatId, message, q, type) {
    try {
        ...
        switch (type) {
            case 'metallic':
                usageErrorText = "Example: .metallic Anonymous";
                break;
            case 'ice':
                usageErrorText = "Example: .ice Anonymous";
                break;
            case 'snow':
                usageErrorText = "Example: .snow Anonymous";
                break;
            case 'impressive':
                usageErrorText = "Example: .impressive Anonymousr";
                break;
            case 'matrix':
                usageErrorText = "Example: .matrix Anonymous;
                break;
            case 'light':
                usageErrorText = "Example: .light Anonymous";
                break;
            case 'neon':
                usageErrorText = "Example: .neon Anonymousr";
                break;
            case 'devil':
                usageErrorText = "Example: .devil Anonymous";
                break;
            case 'purple':
                usageErrorText = "Example: .purple Anonymous";
                break;
            case 'thunder':
                usageErrorText = "Example: .thunder Anonymous";
                break;
            case 'leaves':
                usageErrorText = "Example: .leaves Anonymous";
                break;
            case '1917':
                usageErrorText = "Example: .1917 Anonymous";
                break;
            case 'arena':
                usageErrorText = "Example: .arena Anonymous";
                break;
            case 'hacker':
                usageErrorText = "Example: .hacker Anonymous";
                break;
            case 'sand':
                usageErrorText = "Example: .sand Anonymous";
                break;
            case 'blackpink':
                usageErrorText = "Example: .blackpink Anonymous";
                break;
            case 'glitch':
                usageErrorText = "Example: .glitch Anonymous";
                break;
            case 'fire':
                usageErrorText = "Example: .fire Anonymous";
                break;
            default:
