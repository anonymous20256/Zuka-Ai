    ...
    try {
        ...
        await new Promise((resolve, reject) => {
            exec(ffmpegCommand, (error) => {
                if (error) {
                    console.error('FFmpeg error: - sticker.js:96', error);
                    reject(error);
                } else resolve();
            });
        });
        ...
        const json = {
            ...
            'sticker-pack-name': settings.packname || 'Zuka Ai',
            'emojis': ['🤖']
        };
        ...
        try {
            ...
            console.error('Error cleaning up temp files: - sticker.js:138', err);
        }

    } catch (error) {
        console.error('Error in sticker command: - sticker.js:142', error);
        await sock.sendMessage(chatId, { 
